...
" format
call dein#add('Vimjas/vim-python-pep8-indent', {'on_ft': ['python', 'vim-plug'], 'lazy': 1})
call dein#add('numirias/semshi', {'build':'UpdateRemotePlugins'})

call dein#add('tweekmonster/braceless.vim', {'for': ['python', 'vim-plug'], 'lazy': 1, 'on_ft': 'python'})

"translate
call dein#add('voldikss/vim-translator', {'on_event': 'VimEnter', 'lazy':1})
...
call dein#add('hanschen/vim-ipython-cell', {'on_ft': 'python', 'lazy': 1})
...
call dein#add('junegunn/fzf', {'build': { -> fzf#install() }, 'lazy':1})
...
call dein#add('theniceboy/pair-maker.vim', {'on_event': 'InsertEnter', 'lazy': 1})
call dein#add('Yggdroot/indentLine', {'on_ft': ['python'], 'lazy': 1})
...
call dein#add('luochen1990/rainbow', {'on_ft': ['python', 'vim-plug'], 'lazy': 1})
